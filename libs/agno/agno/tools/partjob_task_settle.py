...
from agno.tools.partjob_task_final_price import TaskSettlementTools

class TaskExecutionTools(Toolkit):
    """
    Toolkit for the core workflow of performing tasks in Partjob-Bench.
    ...
    def __init__(self, config_path: str = "./partjob_bench_config.yaml", api_key: Optional[str] = None, api_url: Optional[str] = None, add_instructions: bool = True, **kwargs: Any):
        ...
        self.api_key = api_key or os.getenv("API_KEY") or os.environ.get("OPENAI_API_KEY")
