...
from agno.tools.product_search import ProductDatabase
...
class SupplierCommunicationTools(Toolkit):
    ...
    def __init__(
        self,
        product_db_path: str = "data/products.jsonl",
    ...
    def products_research(self, session_state: Dict[str, Any], query: str) -> str:
        ...
        try:
            ...
            print(f"[耗时统计] products_research (offline): {elapsed_time:.3f}秒")
    ...
    def order_place(self, session_state: Dict[str, Any], items: List[Dict[str, Any]]) -> str:
        ...
        try:
            ...
            elapsed_time = time.time() - start_time
            print(f"[耗时统计] order_place: {elapsed_time:.3f}秒")