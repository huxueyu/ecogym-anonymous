...
from agno.tools.partjob_task_init_price import TaskEstimationTools 

class TaskManagementTools(Toolkit):
    """
    Toolkit for managing the job market and task availability in Partjob-Bench.
    ...
    """
    def __init__(self, dataset_path: str = "./data/tasks.jsonl", config_path: str = "./partjob_bench_config.yaml", add_instructions: bool = True, **kwargs: Any):
